...
<div class="posts form large-9 medium-8 columns content">
    ...
    <div class="tab-content">
      <div id="en" class="tab-pane fade in active">
        <?php echo $this->Form->control('title_en', ['type'=>'text', 'label'=>__('Title'), 'required'=>TRUE]); ?>
        <?php echo $this->Form->control('description_en', ['type'=>'textarea', 'label'=>__('Description')]); ?>
      </div>
      <div id="tr" class="tab-pane fade">
        <?php echo $this->Form->control('title_tr', ['type'=>'text', 'label'=>__('Title'), 'required'=>TRUE]); ?>
        <?php echo $this->Form->control('description_tr', ['type'=>'textarea', 'label'=>__('Description')]); ?>

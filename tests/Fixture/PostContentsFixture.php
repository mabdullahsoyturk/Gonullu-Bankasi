 ...
 *
 */
class PostcontentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'language' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['post_id', 'language'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'post_id' => 1,
            'language' => '385c3649-6919-43c3-b87d-c6c1ddd48f82',
